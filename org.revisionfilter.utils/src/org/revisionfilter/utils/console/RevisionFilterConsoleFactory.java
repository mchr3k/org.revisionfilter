...
public class RevisionFilterConsoleFactory implements IConsoleFactory
{
  private static IOConsole sConsole = new IOConsole("RevisionFilter Console", null, null, false);
